...
TaskProcessor::TaskProcessor(ModelRunner &nerModel, ModelRunner &classificationModel, HomeAssistantAPI *homeAssistantAPI)
    : nerModel_(nerModel), classificationModel_(classificationModel), homeAssistantAPI_(homeAssistantAPI)
{

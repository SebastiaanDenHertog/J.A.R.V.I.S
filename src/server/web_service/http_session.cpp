...
http_session::http_session(
  ...
  const std::map<std::string, RouteHandler> &route_handlers) : socket_(std::move(socket)), error_handler_(error_handler), route_handlers_(route_handlers), strand_(socket_.get_executor()), timer_(socket_.get_executor().context(),

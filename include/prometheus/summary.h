...
namespace prometheus
{
  ...
  /// server side:
  /// https://prometheus.io/docs/latest/querying/functions/#histogram_quantile.
  ///
  ...
  /// a data race.
  class PROMETHEUS_EXPORT Summary
  {
  public:
  ...
  /// Register(Registry&).
  PROMETHEUS_EXPORT detail::Builder<Summary> BuildSummary();
